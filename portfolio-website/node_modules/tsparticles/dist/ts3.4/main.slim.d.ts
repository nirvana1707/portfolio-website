...
import { ShapeDrawerAfterEffectFunction, ShapeDrawerDestroyFunction, ShapeDrawerDrawFunction, ShapeDrawerInitFunction, RecursivePartial, SingleOrMultiple } from "./Types";
import { IPlugin } from "./Core/Interfaces/IPlugin";
import { Particle } from "./Core/Particle";
export declare class MainSlim {
    private "MainSlim.#private";
    constructor();
    init(): void;
